...
app.delete("/reviews/:id", (req, res) => {
  ...
  // İnceleme silindiğinde, ilgili yorumları da sil
...
// İnceleme silme endpoint'ini güncelle (sadece admin)
...
// İnceleme ekleme endpoint'ini güncelle (sadece giriş yapmış kullanıcılar)
app.post(
  "/reviews",
  checkAuthentication,
  upload.fields([{ name: "cover" }, { name: "fullImage" }]),
